...
const ManageBookingsScreen = ({ navigation }) => {
  ...
  const updateBookingStatus = (bookingId, newStatus) => {
    try {
      ...
      loadBookings();
      Alert.alert('Sukses', `Status booking berhasil diubah menjadi ${getStatusText(newStatus)}`);
    } catch (error) {
  ...
  const handleStatusChange = (booking, newStatus) => {
    ...
    Alert.alert(
      ...
      [
        ...
        { text: 'Ya', onPress: () => updateBookingStatus(booking.id, newStatus) }
      ]
    );
  };
        ...
        <View style={styles.headerContent}>
          <View style={styles.greetingContainer}>
            ...
            <View>
              ...
              <Text style={styles.headerSubtitle}>Kelola pesanan dari customer</Text>
            </View>
          </View>
          <View style={styles.decorativeElements}>
            <Icon name="settings" size={24} color="white" style={styles.manageIcon} />
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Text style={styles.emptyText}>
              {statusFilter === 'all' ? 'Belum ada booking' : `Tidak ada booking dengan status "${getStatusText(statusFilter)}"`}
            </Text>
          </View>
        }
      />
